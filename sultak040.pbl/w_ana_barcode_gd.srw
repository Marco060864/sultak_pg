forward
global type w_ana_barcode_gd from w_semplice_gd
end type
type cb_crea_barcode from commandbutton within w_ana_barcode_gd
end type
type cbx_seleziona from checkbox within w_ana_barcode_gd
end type
type cb_st_barcode from commandbutton within w_ana_barcode_gd
end type
end forward
...
global w_ana_barcode_gd w_ana_barcode_gd

on w_ana_barcode_gd.create
int iCurrent
call super::create
...
type cb_stampa from w_semplice_gd`cb_stampa within w_ana_barcode_gd
end type

type cb_ricerca from w_semplice_gd`cb_ricerca within w_ana_barcode_gd
end type

type cb_primo from w_semplice_gd`cb_primo within w_ana_barcode_gd
end type

type cb_ultimo from w_semplice_gd`cb_ultimo within w_ana_barcode_gd
end type

type cb_indietro from w_semplice_gd`cb_indietro within w_ana_barcode_gd
end type

type cb_avanti from w_semplice_gd`cb_avanti within w_ana_barcode_gd
end type

type dw_1 from w_semplice_gd`dw_1 within w_ana_barcode_gd
integer width = 3209
string dataobject = "d_ana_barcode_gd"
end type
...
type cb_inserisci from w_semplice_gd`cb_inserisci within w_ana_barcode_gd
end type

type cb_salva from w_semplice_gd`cb_salva within w_ana_barcode_gd
end type

type cb_cancella from w_semplice_gd`cb_cancella within w_ana_barcode_gd
end type

type cb_annulla from w_semplice_gd`cb_annulla within w_ana_barcode_gd
end type

type cb_ok from w_semplice_gd`cb_ok within w_ana_barcode_gd
end type
...
event clicked;long li_test, li_prog, ll_righe
integer i
...
ds_prog.dataobject="ds_prog_barcode_conto"
ds_prog.settransobject(sqlca)
ll_righe=ds_prog.retrieve()
ls_max_barcode=ds_prog.getitemstring(ll_righe, "c_prog_conto")
