forward
global type w_lista_documenti from w_selezione_stampa
end type
end forward
...
global w_lista_documenti w_lista_documenti
...
on w_lista_documenti.create
call super::create
end on

on w_lista_documenti.destroy
call super::destroy
end on

type cb_1 from w_selezione_stampa`cb_1 within w_lista_documenti
integer x = 87
integer y = 1184
end type

type cb_stampa from w_selezione_stampa`cb_stampa within w_lista_documenti
integer x = 1696
integer y = 1192
end type
...
openwithparm(w_st_lista_documenti, s_selezione)


end event

type dw_1 from w_selezione_stampa`dw_1 within w_lista_documenti
integer width = 2080
integer height = 1108
string dataobject = "d_lista_documenti"
end type
