forward
global type w_doc_ff_copia20220629 from w_base
end type
type pb_bilancia from picturebutton within w_doc_ff_copia20220629
end type
type dw_cod_barre from udw_000 within w_doc_ff_copia20220629
end type
type cb_nuovo_doc from commandbutton within w_doc_ff_copia20220629
end type
type cb_duplica from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_esplodi from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_stampa from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_cancella from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_salva from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_inserisci from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_annulla from uo_commandbutton within w_doc_ff_copia20220629
end type
type cb_ok from uo_commandbutton within w_doc_ff_copia20220629
end type
type tab_1 from tab within w_doc_ff_copia20220629
end type
...
type internetresult_1 from internetresult within w_doc_ff_copia20220629
end type
end forward
...
global w_doc_ff_copia20220629 w_doc_ff_copia20220629
...
on w_doc_ff_copia20220629.create
int iCurrent
call super::create
...
on w_doc_ff_copia20220629.destroy
call super::destroy
...
type internetresult_1 from internetresult within w_doc_ff_copia20220629 descriptor "pb_nvo" = "true" 
event create ( )
event destroy ( )
end type
