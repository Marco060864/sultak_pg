forward
global type w_doc_ffokcombo20240815 from w_base
end type
type pb_bilancia from picturebutton within w_doc_ffokcombo20240815
end type
type dw_cod_barre from udw_000 within w_doc_ffokcombo20240815
end type
type cb_nuovo_doc from commandbutton within w_doc_ffokcombo20240815
end type
type cb_duplica from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_esplodi from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_stampa from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_cancella from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_salva from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_inserisci from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_annulla from uo_commandbutton within w_doc_ffokcombo20240815
end type
type cb_ok from uo_commandbutton within w_doc_ffokcombo20240815
end type
type tab_1 from tab within w_doc_ffokcombo20240815
end type
...
type internetresult_1 from internetresult within w_doc_ffokcombo20240815
end type
end forward
...
global w_doc_ffokcombo20240815 w_doc_ffokcombo20240815
...
on w_doc_ffokcombo20240815.create
int iCurrent
call super::create
...
on w_doc_ffokcombo20240815.destroy
call super::destroy
...
event clicked;if dw_1.getrow()>0 then
	if messagebox("Attenzione!", "Vuoi davvero cancellare irreversibilmente il documento?", stopsign!, yesno!)=1 then
		dw_1.trigger event ue_delete(dw_1.getrow())
			...
			ldc_peso=getitemdecimal(row, "rdoc_peso")
			 ...
			 if cbx_in_derivazione.checked then
				...
				if not(ls_test="S") then 
					trigger event ue_update()  //20240221 spostato su funzione w_calcola_saldo derivazione
					post setfocus()
...
event updatestart;call super::updatestart;long ll_find, ll_end, I
string ll_list
...
type internetresult_1 from internetresult within w_doc_ffokcombo20240815 descriptor "pb_nvo" = "true" 
event create ( )
event destroy ( )
end type
