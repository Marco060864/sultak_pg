forward
global type w_padre_figlio_cx from w_base
end type
type cb_ricerca from commandbutton within w_padre_figlio_cx
end type
type dw_1 from udw_001 within w_padre_figlio_cx
end type
type dw_2 from udw_002 within w_padre_figlio_cx
end type
type cb_inserisci from commandbutton within w_padre_figlio_cx
end type
type cb_salva from commandbutton within w_padre_figlio_cx
end type
type cb_cancella from commandbutton within w_padre_figlio_cx
end type
type cb_annulla from commandbutton within w_padre_figlio_cx
end type
type cb_ok from commandbutton within w_padre_figlio_cx
end type
end forward
...
global w_padre_figlio_cx w_padre_figlio_cx
