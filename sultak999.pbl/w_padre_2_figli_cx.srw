forward
global type w_padre_2_figli_cx from w_base
end type
type dw_3 from udw_001 within w_padre_2_figli_cx
end type
type dw_2 from udw_001 within w_padre_2_figli_cx
end type
type dw_1 from udw_001 within w_padre_2_figli_cx
end type
type cb_inserisci from uo_commandbutton within w_padre_2_figli_cx
end type
type cb_salva from uo_commandbutton within w_padre_2_figli_cx
end type
type cb_cancella from uo_commandbutton within w_padre_2_figli_cx
end type
type cb_annulla from uo_commandbutton within w_padre_2_figli_cx
end type
type cb_ok from uo_commandbutton within w_padre_2_figli_cx
end type
end forward
...
global w_padre_2_figli_cx w_padre_2_figli_cx
...
event rowfocuschanged;long ll_id  //primary key del master da riportare per il retrieve del detail
