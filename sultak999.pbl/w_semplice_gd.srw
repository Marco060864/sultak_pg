forward
global type w_semplice_gd from w_base
end type
type cb_stampa from uo_commandbutton within w_semplice_gd
end type
type cb_ricerca from uo_commandbutton within w_semplice_gd
end type
type cb_primo from uo_commandbutton within w_semplice_gd
end type
type cb_ultimo from uo_commandbutton within w_semplice_gd
end type
type cb_indietro from uo_commandbutton within w_semplice_gd
end type
type cb_avanti from uo_commandbutton within w_semplice_gd
end type
type dw_1 from udw_001 within w_semplice_gd
end type
type cb_inserisci from uo_commandbutton within w_semplice_gd
end type
type cb_salva from uo_commandbutton within w_semplice_gd
end type
type cb_cancella from uo_commandbutton within w_semplice_gd
end type
type cb_annulla from uo_commandbutton within w_semplice_gd
end type
type cb_ok from uo_commandbutton within w_semplice_gd
end type
end forward
...
global w_semplice_gd w_semplice_gd

on w_semplice_gd.create
int iCurrent
call super::create
