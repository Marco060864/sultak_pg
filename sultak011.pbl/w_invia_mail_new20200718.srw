forward
global type w_invia_mail_new20200718 from w_pop
end type
type cb_1 from commandbutton within w_invia_mail_new20200718
end type
type dw_2 from udw_001 within w_invia_mail_new20200718
end type
type cbx_logfile from checkbox within w_invia_mail_new20200718
end type
type cbx_debugviewer from checkbox within w_invia_mail_new20200718
end type
type lb_attachments from listbox within w_invia_mail_new20200718
end type
type cbx_sendhtml from checkbox within w_invia_mail_new20200718
end type
type cb_inserisci from commandbutton within w_invia_mail_new20200718
end type
type cb_salva from commandbutton within w_invia_mail_new20200718
end type
type cb_cancella from commandbutton within w_invia_mail_new20200718
end type
type cb_allegati from commandbutton within w_invia_mail_new20200718
end type
type cb_canc_allegati from commandbutton within w_invia_mail_new20200718
end type
type dw_3 from udw_001 within w_invia_mail_new20200718
end type
type rb_solo_mail from radiobutton within w_invia_mail_new20200718
end type
type rb_solo_pec from radiobutton within w_invia_mail_new20200718
end type
type rb_entrambe from radiobutton within w_invia_mail_new20200718
end type
type cb_mailsend from commandbutton within w_invia_mail_new20200718
end type
end forward
...
global w_invia_mail_new20200718 w_invia_mail_new20200718
...
on w_invia_mail_new20200718.create
int iCurrent
call super::create
...
on w_invia_mail_new20200718.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.dw_2)
...
if is_tipo_ae> "TD" then //è un fat elettronica il destinatario è da recuperare in azienda, HUB_ae
		select hub_ae
		into :ls_mail.s_email_1
		from dba.azienda
		;
		if isnull(ls_mail.s_email_1) or ls_mail.s_email_1<" " then
...
type dw_1 from w_pop`dw_1 within w_invia_mail_new20200718
integer x = 50
integer y = 52
integer width = 2007
integer height = 704
